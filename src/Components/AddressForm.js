        ...
        <FormRaw>
          <LefttSide>
            ...
            <Autocomplete
              ...
              sx={{ textDecoration: 'none', "& .MuiAutocomplete-root": { border: 0, p: 6 } }}
              options={countries}
              autoHighlight
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  sx={{ color: "var(--type-low-emphasis)", backgroundColor: '#F1F1F1', fontSize: 14, mb: 2, border: 0, p: 1, textDecoration: 'none', borderRadius:1 }}
