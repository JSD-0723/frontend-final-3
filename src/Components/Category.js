...
function Category() {
    return (
        ...
        >
            ...
            <Typography level="h2" sx={{ color: '#1B4B66' }}>Category Name</Typography>
            <Grid container spacing={{ xs: 1, sm: 2, md: 3 }} columns={{ xs: 6, sm: 6, md: 12 }} sx={{ gap: 3, width: 1 / 1, justifyContent: 'flex', py: 6, px: 3 }}>
