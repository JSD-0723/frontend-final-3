...
function Handpicked() {
    return (
        <Box sx={{ background: '#1B4B66' }}>
            <Typography level="h2" fontSize="2rem" sx={{ color: 'white', pl:3.5, pt:3 }}>
                Handpicked Collections
            </Typography>
            <Grid container spacing={{ xs: 1, sm: 2, md: 3 }} columns={{ xs: 6, sm: 6, md: 12 }} sx={{ gap: 3, width: 1 / 1, justifyContent: 'space-evenly', py: 6, px: 3 }}>
